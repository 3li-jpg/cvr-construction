            ...
            <div className="flex max-w-[58rem] flex-col items-center">
              ...
              <Reveal direction="up" delay={0.35} duration={0.8}>
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="z-10 flex flex-col items-center gap-2 text-sm font-semibold uppercase tracking-[0.12em] text-white/60 sm:flex-row sm:gap-4">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className={`${metaLinkClassName} mt-3 flex w-fit text-[0.72rem] font-semibold uppercase tracking-[0.15em] text-white/60`}
                        >
                          {showroomContact.email.toUpperCase()}
                        </a>
                      </div>
                    </div>
                    {bbbAccreditedHref ? (
