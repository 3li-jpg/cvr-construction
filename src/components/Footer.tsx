    ...
    <>
      {showCta ? (
        <section
          ...
          className="relative isolate z-0 flex h-[100svh] min-h-[100svh] w-full items-center justify-center overflow-hidden bg-black text-white md:sticky md:top-0 md:h-[100dvh] md:min-h-[100dvh]"
        >
          <Image
